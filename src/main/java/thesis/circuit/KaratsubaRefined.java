...
public class KaratsubaRefined extends Circuit {
    private final @NotNull Bus outputs;

    public KaratsubaRefined(int bits) {
        super(bits * 2);

        if (bits == 1) {
            outputs = new Bus(List.of(new AndGate(inputs.get(0), inputs.get(1))));
        } else if (bits % 2 != 0) {
            KaratsubaRefined nextKaratsuba = new KaratsubaRefined(bits + 1);
            ...
            KaratsubaRefined a0b0 = new KaratsubaRefined(a0, b0);
            KaratsubaRefined a1b1 = new KaratsubaRefined(a1, b1);
            Adder a0Plusa1 = new Adder(a0, a1);
            Adder b0Plusb1 = new Adder(b0, b1);
            KaratsubaRefined a0Plusa1b0Plusb1 = new KaratsubaRefined(a0Plusa1.outputBus(), b0Plusb1.outputBus());
    ...
    public KaratsubaRefined(@NotNull Bus a, @NotNull Bus b) {
        if (a.size() != b.size()) {
